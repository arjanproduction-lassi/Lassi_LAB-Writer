...
a headless synthetic controller that maps c2b1 public state into frozen
text-free UI state. Later approved c2b2b remains the only phase allowed to
trigger the first real read after a click.
